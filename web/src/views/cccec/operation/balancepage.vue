...
<script>
    ...
    import {
        getuser,bindingoperNo,getrolelist,saveoperator,saveoperatorrole,getgoodsupplier,getareabox,getarealevel,saveareapartner,getareapartner,getbalancepage
    }
    from "../../api/api.js";
    export default {
        name: "extension",
        ...
        methods: {
            init(){
                ...
                getbalancepage(null, null, memberId).then(response => {
            ...
            getpeopleList(val) {
                ...
                var sorts = "";
                var memberId = this.$route.query.id;
                getbalancepage(val, this.pagesizes, memberId).then(response => {
