...
<script>
    ...
    import {
        getuser,bindingoperNo,getrolelist,saveoperator,saveoperatorrole,getgoodsupplier,getareapartner,getpointpage
    }
    from "../../api/api.js";
    export default {
        name: "extension",
        ...
        methods: {
            init(){
                ...
                getpointpage(null, null, memberId).then(response => {
            ...
            getpeopleList(val) {
                ...
                var sorts = "";
                var memberId = this.$route.query.id;
                getpointpage(val, this.pagesizes, memberId).then(response => {
