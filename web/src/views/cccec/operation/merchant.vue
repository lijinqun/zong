    ...
    <div>
            ...
            <card>
                ...
                <div class="sreach">
                    <div class="sreach-page">
                        <div class="sreach-box"><span>商店名称:</span>
                            <i-input v-model="usernames" placeholder="请输入商店名称..."></i-input>
                        </div>
        ...
        <modal v-model="saveuserBox" width="450">
            ...
            <div class="flexbox">
                ...
                <div class='flex5'>
                    <i-select v-model="levelType" clearable="" filterable="" @on-selection-change="selectType" @on-change="selectType">
            ...
            <div class="flexbox">
                ...
                <div class='flex5'>
                    <i-select v-model="province" clearable="" ref="provinceref" filterable="" :disabled="provinceable">
            ...
            <div class="flexbox">
                ...
                <div class='flex5'>
                    <i-select v-model="city" clearable="" ref="cityref"  filterable="" :disabled="cityable">
            ...
            <div class="flexbox">
                ...
                <div class='flex5'>
                    <i-select v-model="town" clearable="" ref="townref"  filterable=""  :disabled="townable">
...
<script>
    ...
    import {
        getuser,bindingoperNo,getrolelist,saveoperator,saveoperatorrole,getgoodsupplier,getareabox,getmerchantpage
    }
    from "../../api/api.js";
    export default {
        name: "extension",
        ...
        methods: {
            ...
            getpeopleList(val) {
                ...
                var sorts = "";
                getmerchantpage(val, this.pagesizes,this.usernames).then(response => {
