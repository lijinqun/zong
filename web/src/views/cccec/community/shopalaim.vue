        ...
        <row>
            <card>
                <div class="sreach">
                    ...
                    <div class="sreach-page">
                        <div class="sreach-box sreach-box2" style="text-align: right;">
                            <i-button @click="gettransferlist2(1)" type="info">搜索</i-button>
                        </div>
                ...
                <div class="page-box" style="text-align:right;margin-top:15px;">
                    <page :total="pageCount" :page-size="pagesizes" show-elevator="" show-total="" @on-change="gettransferlist2"></page>
                </div>
            </card>
        </row>
...
<script>
    ...
    import {
        getshop,updateshop,getshopcatId,updateshopstatus,updateshoparea,getarealevel,gettransferlist2,
    }
    from "./../../api/api.js";
    export default {
        components: {
...
//                 }
        ...
        methods: {
            init(){
                gettransferlist2().then(response => {
            ...
            gettransferlist2(val) {
                ...
                gettransferlist2(val,this.shopName,this.username,this.tradeType,this.tradeStatus,this.province,this.city,this.town).then(response => {
                    this.shopName ='';
                    this.username ='';
            ...
            upBatchUpdate(){
                ...
                updateshop(this.ids,this.choiceid).then(response => {
                    if(response.code=="200"){
                        ...
                        zhethis.gettransferlist2(zhethis.pageNumber);
                        zhethis.ids="";
            ...
            clickuser(data){
                this.gettransferlist2(this.pageNumber);
                this.showuser=data;
            },
             selectIds(selection) {
