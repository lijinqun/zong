        ...
        <row>
            <card>
                ...
                <div class="sreach">
                    ...
                    <div class="sreach-page">
                         <div class="sreach-box sreach-box2" style="text-align: right;">
                            <i-button type="info" icon="ios-search" @click="getnorder(1)">搜索</i-button> 
                ...
                <div class="page-box" style="text-align:right;margin-top:15px;">
                    <page :total="pageCount" :page-size="pagesizes" :current="pageNumber" show-elevator="" show-total="" @on-change="getnorder"></page>
                </div>
...
//                 },
        ...
        mounted() {
            ...
            if (sessionStorage.getItem("orderpeoplelists")) {
                ...
                this.getnorder(this.pageNumber,this.pageSizes);
            }else{
        ...
        methods: {
            ...
            checkAllGroupChange (data) {
                ...
                // this.getnorder(null, null, null,null,null,null,null,null, this.orderstatus,null,null, null,null,null, null,null, null, null,null,null, null,null,null);
                if (data.length === 6) {
                    this.indeterminate = false;
                    this.checkAll = true;
            ...
            updatestatus(id,status){
                ...
                updatanewstatus(id,status).then(response => {
                        ...
                        if(response.success){
                            ...
                            zhethis.getnorder(zhethis.pageNumber,zhethis.pageSizes);
                        }else{
                ...
                if (this.ids !== null && this.ids  !== undefined && this.ids  !== '') {
                    ...
                    updateconfirmoreder(this.ids).then(response => {
                        if(response.code=="200"){
                            ...
                            this.getnorder(this.pageNumber,this.pageSizes,null,null,null,null,null,null,this.orderstatus);
                        }else{
                            this.$Modal.error({
                                title: '温馨提示',
