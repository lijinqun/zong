    ...
    <div class="main" :class="{'main-hide-text': hideMenuText}">
        <div class="sidebar-menu-con" :style="{width: hideMenuText?'60px':'200px', overflow: hideMenuText ? 'visible' : 'auto', background: $store.state.menuTheme === 'dark'?'#495060':'white'}">
            <div class="logo-con">
                ...
                <span class="logotxt" v-show="!hideMenuText" key="max-logo">从众链商</span>
            ...
            saveEditPass () {
                this.$refs['editPasswordForm'].validate((valid) => {
                    if (valid) {
                        ...
                        updatePassword(this.editPasswordForm.oldPass,this.editPasswordForm.newPass,this.editPasswordForm.rePass).then(response => {
                            if (response.success) {
