<template>
  <div class="phone">
    <top-header title="交易密码"></top-header>
    ...
    <div class="pwbox pwbox-top">
      ...
      <p><span class="headtxt">新密码</span>
        <span class="datatxt" v-text="newTradePassword" @click='showKeyboard2=true'></span>
      </p>
    </div>
    <div class="pwbox">
      <p><span class="headtxt">确认密码</span>
        <span class="datatxt" v-text="confirmedNewTradePassword" @click='showKeyboard3=true'></span>
      </p>
    </div>
