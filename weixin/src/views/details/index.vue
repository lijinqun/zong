<template>
  <div class="page">
        ...
        <div class="user">
            <p class="van-hairline--bottom">认领用户信息</p>
            <ul>
        ...
        <div class="btn">
            <button v-show="data.memberId != userInfo.id" @click="href(route)">认领</button>
  ...
  methods: {
        ...
        detailsList(){
            ...
            detailsList(this.$route.params.id).then(res=>{
                if(res.code == 200){
                    _this.data = res.data;
                   _this.totalQuantity = res.data.tradedQuantity / res.data.totalQuantity * 100
                }
            })
        },
        recordList(){
