...
! (function () {
  ...
  var l = [
    ...
    q = p ? o : m() ? function () {
      function a() {
        this._elImage.src = this._elCanvas.toDataURL("image/png"), this._elImage.style.display = "block",this._elImage.style.margin = "0 auto", this._elCanvas.style.display = "none"
      }
